...
def main():
	...
	lst_joint_angles_1 = [math.radians(170), math.radians(0), math.radians(0), math.radians(0), math.radians(0), math.radians(0)]

	lst_joint_angles_2 = [math.radians(133), math.radians(-59), math.radians(13), math.radians(-134), math.radians(47), math.radians(23)]

	lst_joint_angles_3 = [math.radians(-70), math.radians(-54), math.radians(-139), math.radians(-174), math.radians(9), math.radians(6)]
