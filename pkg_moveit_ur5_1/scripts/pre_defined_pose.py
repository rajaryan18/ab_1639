...
def main():
    ...
    ur5.go_to_predefined_pose("stare")
    rospy.sleep(2)
    ur5.go_to_predefined_pose("attack")
    rospy.sleep(2)
    ur5.go_to_predefined_pose("closed")
    rospy.sleep(2)
    ur5.go_to_predefined_pose("drop")
    rospy.sleep(2)
    ur5.go_to_predefined_pose("open")
    rospy.sleep(2)
    ur5.go_to_predefined_pose("stare_2")
    rospy.sleep(2)
    ur5.go_to_predefined_pose("attack_2")
    rospy.sleep(2)
    ur5.go_to_predefined_pose("close_2")
    rospy.sleep(2)
    ur5.go_to_predefined_pose("drop_2")
    rospy.sleep(2)
    ur5.go_to_predefined_pose("open")
    rospy.sleep(2)
    ur5.go_to_predefined_pose("stare_3")
    rospy.sleep(2)
    ur5.go_to_predefined_pose("attack_3")
    rospy.sleep(2)
    ur5.go_to_predefined_pose("close_3")
    rospy.sleep(2)
    ur5.go_to_predefined_pose("drop_3")
    rospy.sleep(2)
    ur5.go_to_predefined_pose("open")
    rospy.sleep(2)
